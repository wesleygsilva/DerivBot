...
class IAGladiator {
  ...
  // Retorna o payout correto dependendo do estado atual da estratégia
  getPayout() {
    // No estado normal, o payout é 19%. No gale, é 85%.
    if (this.config.currentState === 'NORMAL') {
      return 0.19;
    } else {
      return 0.85;
    }
    ...
    switch (state.currentState) {
      case 'NORMAL':
        ...
        return {
          ...
          entryType: "DIGITOVER",
          barrier: 2,
          reason: "IA Gladiator: Entrada Padrão Over 2"
        };
        ...
        if (digit < 5) {
          ...
          if (state.sequenceCounter >= requiredSequence) {
            ...
            return {
              ...
              entryType: "DIGITOVER",
              barrier: 4,
              reason: `IA Gladiator: Gale ${state.martingaleCount} Over 4 (após sequência)`
            };
          }
        } else {
      ...
      case 'GALE_ACTIVE':
        ...
        return {
          ...
          entryType: "DIGITOVER",
          barrier: 4,
          reason: `IA Gladiator: Gale ${state.martingaleCount} Over 4`
        };
